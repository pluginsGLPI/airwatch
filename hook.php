 ...
 * @version $Id$
 ...
 function plugin_airwatch_getAddSearchOptions($itemtype) {
    ...
    if ($itemtype == 'Computer') {
          ...
          $sopt[6000]['name']          = __('Airwatch ID', 'airwatch');
          ...
          $sopt[6001]['name']          = __('IMEI', 'airwatch');
         ...
         $sopt[6002]['name']          = __('Simcard serial number', 'airwatch');
         ...
         $sopt[6003]['name']          = __('Last seen', 'airwatch');
         ...
         $sopt[6004]['name']          = __('Last enrollment date', 'airwatch');
         ...
         $sopt[6005]['name']          = __('Last enrollment check date', 'airwatch');
         ...
         $sopt[6006]['name']          = __('Last compliance check date', 'airwatch');
         ...
         $sopt[6007]['name']          = __('Last compromised check date', 'airwatch');
         ...
         $sopt[6008]['name']          = __('Enrollment status', 'airwatch');
         ...
         $sopt[6009]['name']          = __('Compliance status', 'airwatch');
         ...
         $sopt[6010]['name']          = __('Compromised status', 'airwatch');
         ...
         $sopt[6011]['name']          = __('Data encryption', 'airwatch');
         ...
         $sopt[6012]['name']          = __('Roaming enabled', 'airwatch');
         ...
         $sopt[6013]['name']          = __('Data roaming enabled', 'airwatch');
         ...
         $sopt[6014]['name']          = __('Voice roaming enabled', 'airwatch');
